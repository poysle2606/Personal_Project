...
@Component({
  selector: 'app-verity-resest-password',
  templateUrl: './verity-resest-password.component.html',
  styleUrls: ['./verity-resest-password.component.css']
})
export class VerityResestPasswordComponent implements OnInit {
